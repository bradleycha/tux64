...
export TUX64_CFLAGS_N64_COMMON="-pipe -march=vr4300 -mfix4300 -mabi=o64 -Oz -flto -fno-stack-protector"
...
export TUX64_CFLAGS_N64_KERNEL="${TUX64_CFLAGS_N64_COMMON} -fno-lto -mabi=64"
