...
export TUX64_CFLAGS_HOST="-pipe -march=native -O2"
export TUX64_CXXFLAGS_HOST="${TUX64_CFLAGS_HOST}"
export TUX64_ASFLAGS_HOST=""
export TUX64_LDFLAGS_HOST="-flto -Wl,--gc-sections -s"

export TUX64_CFLAGS_N64_COMMON="-pipe -march=vr4300 -mfix4300 -mabi=o64 -Oz -fno-stack-protector -fomit-frame-pointer -ffunction-sections -fdata-sections"
