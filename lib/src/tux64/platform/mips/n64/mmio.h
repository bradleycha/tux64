...
/*----------------------------------------------------------------------------*/
/* lib/src/tux64/platform/mips/n64/mmio.h - Memory-mapped I/O (MMIO).         */
/*----------------------------------------------------------------------------*/

#ifndef _TUX64_PLATFORM_MIPS_N64_MMIO_H
#define _TUX64_PLATFORM_MIPS_N64_MMIO_H
/*----------------------------------------------------------------------------*/
...
struct Tux64PlatformMipsN64MmioRegistersVi {
   Tux64UInt32 ctrl;
   Tux64UInt32 origin;
   Tux64UInt32 width;
   Tux64UInt32 v_intr;
...
struct Tux64PlatformMipsN64MmioRegistersAi {
...
struct Tux64PlatformMipsN64MmioRegistersPiBsdDom {
   Tux64UInt32 lat;
   Tux64UInt32 pwd;
   Tux64UInt32 pgs;
   Tux64UInt32 rls;
...
struct Tux64PlatformMipsN64MmioRegistersPi {
   Tux64UInt32 dram_addr;
   ...
   Tux64UInt32 status;
   struct Tux64PlatformMipsN64MmioRegistersPiBsdDom
   bsd_dom [TUX64_PLATFORM_MIPS_N64_PI_BSD_DOM_COUNT];
   ...
   Tux64UInt32 ique_atb_lower [TUX64_PLATFORM_MIPS_N64_PI_IQUE_ATB_LOWER_COUNT];
};

struct Tux64PlatformMipsN64MmioRegistersRi {
   Tux64UInt32       mode;
   Tux64UInt32       config;
...
struct Tux64PlatformMipsN64MmioRegistersSi {
   Tux64UInt32       dram_addr;
...
extern volatile struct Tux64PlatformMipsN64MmioRegistersVi
tux64_platform_mips_n64_mmio_registers_vi
__attribute__((section(".tux64.platform.mips.n64.mmio.vi")));
extern volatile struct Tux64PlatformMipsN64MmioRegistersAi
tux64_platform_mips_n64_mmio_registers_ai
__attribute__((section(".tux64.platform.mips.n64.mmio.ai")));
extern volatile struct Tux64PlatformMipsN64MmioRegistersPi
tux64_platform_mips_n64_mmio_registers_pi
__attribute__((section(".tux64.platform.mips.n64.mmio.pi")));
extern volatile struct Tux64PlatformMipsN64MmioRegistersRi
tux64_platform_mips_n64_mmio_registers_ri
__attribute__((section(".tux64.platform.mips.n64.mmio.ri")));
extern volatile struct Tux64PlatformMipsN64MmioRegistersSi
tux64_platform_mips_n64_mmio_registers_si
__attribute__((section(".tux64.platform.mips.n64.mmio.si")));

/*----------------------------------------------------------------------------*/
#endif /* TUX64_CONFIG_PLATFORM_MIPS_N64 */

/*----------------------------------------------------------------------------*/
#endif /* _TUX64_PLATFORM_MIPS_N64_MMIO_H */
