...
/* MI_MODE bits */
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_REPEAT_CLEAR\
   (1u <<  7u)
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_REPEAT_SET\
   (1u <<  8u)
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_EBUS_CLEAR\
   (1u <<  9u)
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_EBUS_SET\
   (1u << 10u)
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_CLEAR_DP\
   (1u << 11u)
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_UPPER_CLEAR\
   (1u << 12u)
#define TUX64_PLATFORM_MIPS_N64_MI_MODE_BIT_UPPER_SET\
   (1u << 13u)
