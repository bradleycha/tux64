...
tux64_boot_stage0_start:
   ...
   addiu $s4,$zero,TUX64_BOOT_STAGE0_PI_STATUS_BIT_MASK_DMA_IO_BUSY
   sw    $s4,TUX64_BOOT_STAGE0_ADDRESS_PI_STATUS($s2)
   ...
   lui   $s6,TUX64_BOOT_STAGE0_BOOT_HEADER_MAGIC_HI # branch delay slot
