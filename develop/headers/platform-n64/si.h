...
#define TUX64_PLATFORM_N64_SI_MMIO_ADDRESS_PIF_AD_RD64B\
   (\
      TUX64_PLATFORM_N64_MEMORY_MAP_ADDRESS_SI +\
      0x00000004u\
   )
#define TUX64_PLATFORM_N64_SI_MMIO_ADDRESS_PIF_AD_WR4B\
   (\
      TUX64_PLATFORM_N64_MEMORY_MAP_ADDRESS_SI +\
      0x00000008u\
   )
#define TUX64_PLATFORM_N64_SI_MMIO_ADDRESS_PIF_AD_WR64B\
   (\
      TUX64_PLATFORM_N64_MEMORY_MAP_ADDRESS_SI +\
      0x00000010u\
   )
#define TUX64_PLATFORM_N64_SI_MMIO_ADDRESS_PIF_AD_RD4B\
   (\
      TUX64_PLATFORM_N64_MEMORY_MAP_ADDRESS_SI +\
      0x00000014u\
   )
#define TUX64_PLATFORM_N64_SI_MMIO_ADDRESS_STATUS\
   (\
      TUX64_PLATFORM_N64_MEMORY_MAP_ADDRESS_SI +\
      0x00000018u\
   )
